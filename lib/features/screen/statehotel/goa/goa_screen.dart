...
class _GoaScreenState extends State<GoaScreen> {
  ...
  String selectedPriceRange = '₹2000 - ₹2500';
  ...
  void applyFilters() {
    setState(() {
      ...
      if (selectedPriceRange == '₹2000 - ₹2500') {
        minPrice = 2000;
        maxPrice = 2500;
      } else if (selectedPriceRange == '₹2500 - ₹3000') {
        minPrice = 2500;
        maxPrice = 3000;
  ...
  // Rest of the methods remain the same as Mumbai screen
  ...
  // Include all the bottom sheet methods from Mumbai screen with same implementation
  ...
  void _showPriceFilter(BuildContext context) {
    showCommonBottomSheet(
      ...
      child: StatefulBuilder(
        builder: (context, setState) {
          final priceDistribution = [80, 120, 60];
          return Padding(
            padding: const EdgeInsets.all(16.0),
            child: Column(
              mainAxisSize: MainAxisSize.min,
